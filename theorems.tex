...
%\definecolor{contcol}{HTML}{28a8a1} %For context

% Define custom colors using Atom Material Light theme
\definecolor{defscol}{HTML}{FFD54F} % Amber for Definitions
\definecolor{defscolaccent}{HTML}{A28832}

\definecolor{exmscol}{HTML}{5C6BC0} % Indigo for Examples
\definecolor{exmscolaccent}{HTML}{FFFFFF}

\definecolor{rmkscol}{HTML}{CDDC39} % Lime for Remarks
\definecolor{rmkscolaccent}{HTML}{737F10}

\definecolor{asumscol}{HTML}{EF5350} % Red for Assumptions
\definecolor{asumcolaccent}{HTML}{59FCFF}

\definecolor{lemscol}{HTML}{607D8B} % BlueGrey for Lemmas
\definecolor{lemscolaccent}{HTML}{FFFFFF}

\definecolor{thmscol}{HTML}{7E57C2} % Purple for Theorems
\definecolor{thmscolaccent}{HTML}{B0E457}

\definecolor{prpscol}{HTML}{795548} % Brown for Propositions
\definecolor{prpscolaccent}{HTML}{FFFFFF}

\definecolor{corscol}{HTML}{80DEEA} % Cyan for Corollaries
\definecolor{corscolaccent}{HTML}{528C94}

\definecolor{clmscol}{HTML}{009688} % Teal for Claims
\definecolor{clmscolaccent}{HTML}{FFFFFF}

\definecolor{facscol}{HTML}{AAD875} % Green for Facts
\definecolor{facscolaccent}{HTML}{6F8853}

\definecolor{contscol}{HTML}{EC407A} % Pink for Context
\definecolor{contscolaccent}{HTML}{46FFC1}
...
\newtcbtheorem[use counter from=mydefinition]{mycontext}{Context}
{
    enhanced,
    frame hidden,
    titlerule=0mm,
    ...
    fonttitle=\bfseries\large,
    coltitle=black,
    colbacktitle=contscol!40!white,
    colback=contscol!20!white,
}{asum}

\NewDocumentCommand{\cont}{m+m}{
    \begin{mycontext}{#1}{}
        #2
    \end{mycontext}
}

\NewDocumentCommand{\contr}{mm+m}{
    \begin{mycontext}{#1}{#2}
        #3
    \end{mycontext}
}
...
% \begin{tcolorbox}[colback=atomOneLightYellow,colframe=yellow!15!black,title= \textbf{Définition \thechapter \ $\blacklozenge$ \thedefo \ | #1}]}{\end{tcolorbox}}
